...
function calcTextDimensions(text, fontSize) {
  if (typeof document === 'undefined' || typeof window === 'undefined') {
    throw new Error('Unexpected error: text dimensions can only be calculated on the client, not the server.');
  }
  if (fontSize < 1) {
...
const ActivityCalendar = ({
  ...
  const weekdayLabelOffset = showWeekdayLabels ? maxWeekdayLabelLength(firstWeek, weekStart, labels.weekdays, fontSize) + LABEL_MARGIN : undefined;
  ...
  function renderFooter() {
    ...
    return /*#__PURE__*/jsxRuntime.jsxs("footer", {
      ...
      children: [loading && /*#__PURE__*/jsxRuntime.jsx("div", {
        ...
        }), Array(maxLevel + 1).fill(undefined).map((_, level) => /*#__PURE__*/jsxRuntime.jsx("svg", {
          width: blockSize,
          height: blockSize,
        ...
        }, level)), /*#__PURE__*/jsxRuntime.jsx("span", {
          style: {
            marginLeft: '0.4em'
          },
  ...
  function renderLabels() {
    ...
    return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [showWeekdayLabels && weeks[0] && /*#__PURE__*/jsxRuntime.jsx("g", {
        className: getClassName('legend-weekday'),
        children: weeks[0].map((_, index) => {
          if (index % 2 === 0) {
            return null;
          }
          const dayIndex = (index + weekStart) % 7;
      ...
      }), !hideMonthLabels && /*#__PURE__*/jsxRuntime.jsx("g", {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("article", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("svg", {
        ...
        children: [!loading && renderLabels(), renderCalendar()]
      })
    }), renderFooter()]
  });
};
