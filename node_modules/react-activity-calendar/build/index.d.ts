...
import { CSSProperties, DOMAttributes, HTMLAttributes, JSXElementConstructor, ReactElement, SVGAttributes } from 'react';
...
declare const ActivityCalendar: ({ data: activities, blockMargin, blockRadius, blockSize, colorScheme, eventHandlers, fontSize, hideColorLegend, hideMonthLabels, hideTotalCount, labels: labelsProp, maxLevel, loading, renderBlock, showWeekdayLabels, style: styleProp, theme: themeProp, totalCount: totalCountProp, weekStart, }: Props) => import("react").JSX.Element | null;
